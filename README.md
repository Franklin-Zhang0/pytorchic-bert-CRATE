# Pytorchic BERT CRATE
### Disclaimer
- This is a modified branch of [pytorchic-bert](https://github.com/dhlee347/pytorchic-bert). 
- CRATE (Coding RAte reduction TransformEr) is a interpretable transformer architecture. This repo make use of CRATE as the base model of BERT. The code of CRATE in this branch is a modified version of [CRATE](https://github.com/Ma-Lab-Berkeley/CRATE)
